...
//                                .requestMatchers(HttpMethod.PUT).permitAll()      //PermitAll() removes security checks, if you want a specific http method to be authenticated, you replace it with authenticated()
